 ...
 */
public final class CustomMp3Extractor implements Extractor {


    public static class Factory implements ExtractorsFactory {
        private int defaultBitrate;

        public Factory(int defaultBitrate) {
            this.defaultBitrate = defaultBitrate;
        }

        @Override
        public Extractor[] createExtractors() {
            return new Extractor[] {new CustomMp3Extractor(defaultBitrate, false)};
        }
    }
     ...
     */
    public CustomMp3Extractor(@Flags int flags) {
        this(flags, C.TIME_UNSET);
    }

    public CustomMp3Extractor(int bitrate, boolean something) {
        this(0);
     ...
     */
    public CustomMp3Extractor(@Flags int flags, long forcedFirstSampleTimestampUs) {
        this.flags = flags;
    ...
    public int read(ExtractorInput input, PositionHolder seekPosition)
        ...
        if (seeker == null) {
            ...
            trackOutput.format(Format.createAudioSampleFormat(null, synchronizedHeader.mimeType, null,
                    bitrate, MpegAudioHeader.MAX_FRAME_SIZE_BYTES, synchronizedHeader.channels,
