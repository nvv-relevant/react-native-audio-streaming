...
public final class CustomLoadControl implements LoadControl {
     ...
     */
    public static final int DEFAULT_MIN_BUFFER_MS = 200000;

    /**
     * The default maximum duration of media that the player will attempt to buffer, in milliseconds.
     */
    public static final int DEFAULT_MAX_BUFFER_MS = 200000;
     ...
     */
    public static final int LOADING_PRIORITY = 100;
    ...
    public void onTracksSelected(Renderer[] renderers, TrackGroupArray trackGroups,
        ...
        targetBufferSize = (int) (256 / 8 * maxBufferUs / 1000);
    ...
    //    Log.e("Buffering", "current buff Dur: " + bufferedDurationUs / 1000 + ", max buff:" + maxBufferUs / 1000 + " shouldContinueLoading: " + isBuffering);
        return isBuffering;
    }
